	...
	class OrderController extends Controller {
		...
		public function deleteOrder() {
			...
			if(method_post()){
                ...
                $result_menu = $this->model('master')->getMenuByOrderId($id);
                $result_table = $this->model('master')->getTableID($table_id)->row;
                sendNoti('มีการลบออเดอร์ โต๊ะ: '.$result_table['table_name'].' เมนู: '.$result_menu['name']);
