...
<script>
    ...
    $(document).on('click','.edit-order',function(e){
        ...
        var option_id      = $('#editModal .btn-outline-primary.active input[name="option"]').data('id');
        var option_price      = $('#editModal .btn-outline-primary.active input[name="option"]').data('price');
        var option      = $('#editModal .btn-outline-primary.active input[name="option"]').data('name');
